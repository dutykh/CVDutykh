...
\begin{etaremune}
  ...
  \item D.~Batic, \textbf{D.~Dutykh} and M.~Sukaiti. \textit{Locally superluminal but not globally acausal wormholes in $f(R, T) = R+\sigma R T$ gravity}. Submitted, 2026 % No - (Arxiv, HAL, RG)
