...
\begin{etaremune}
  ...
  \item \textbf{D.~Dutykh}. \textit{Beyond a Single Mechanism: Universality Classes of Zipf and Power Laws - Theory, Diagnostics, and Reproducible Experiments}. Submitted, 2026 % No - (Arxiv, HAL, RG)
  ...
  \item D.~Batic, \textbf{D.~Dutykh} and F.~Scardigli. \textit{Quasinormal modes of Bonanno--Reuter black holes via the Spectral Method}. Submitted, 2026 % No - (Arxiv, HAL, RG)
