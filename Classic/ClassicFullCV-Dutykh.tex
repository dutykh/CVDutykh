...
\begin{etaremune}
  ...
  \item A.~Deeb, \textbf{D.~Dutykh} and M.~Al~Zohbi. \textit{Error estimation for numerical approximations of ODEs via composition techniques. Part II: Backward difference formulas}. Accepted to Comp. Appl. Math., 2026 % No (HAL, Arxiv, RG)
