...
\begin{etaremune}
  ...
  \item P.~Kundu, S.~Sarkar and \textbf{D.~Dutykh}. \textit{Viscoelastic Deformation Analysis of a Non-Planar Fault in Burger's Rheology Medium}, Submitted, 2025 % No (HAL & Arxiv)

  \item D.~Batic, \textbf{D.~Dutykh} and M.~Sukaiti. \textit{Exact Spinning Morris--Thorne Wormhole with Ergoregion and Stable Causality}. Submitted, 2025 % No - (Arxiv, HAL, RG)
