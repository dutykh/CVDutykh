...
\begin{description}
  ...
  \item[January 2026 -- present:] Associate Dean of Graduate Studies, College of Computing and Mathematical Sciences, Khalifa University of Science and Technology, Abu Dhabi, United Arab Emirates
...
\begin{description}
  ...
  \item[M. Khawariz \textsc{Andaristiyan}:] Research Center for Satellite Technology, National Research and Innovation Agency, Bogor, Indonesia
  \item[Flavio \textsc{Anselmetti}:] Insitute of Geological Sciences, University of Bern, Bern, Switzerland
  ...
  \item[Christian \textsc{Boehmer}:] Department of Mathematics, University College Londond, UK
  \item[St\'ephanie \textsc{Bolik}:] Labotatoire Physiologie Cellulaire et V\'eg\'etale (LPCV), CEA, CNRS, INRA, Grenoble, France
  \item[Liliane \textsc{Bou--Nassif}:] Centre d'\'Energ\'etique et de Thermique de Lyon (CETHIL), INSA de Lyon, France
  ...
  \item[Anna \textsc{Chrysostomou}:] Laboratoire de Physique Th\'eorique et Hautes \'Energies --- LPTHE, Sorbonne Universit\'e, Paris, France
  ...
  \item[Herv\'e \textsc{Colin}:] CEA Grenoble/INES, Laboratory for Solar Systems (L2S), Le Bourget-du-Lac, France
  ...
  \item[Alan S. \textsc{Cornell}:] Department of Physics, University of Johannesburg, Johannesburg, South Africa
  ...
  \item[Edward \textsc{Duarte}:] EDYTEM, Universit\'e Savoie Mont-Blanc, CNRS, Le Bourget-du-Lac, France
  ...
  \item[Joud \textsc{Faraji}:] Mathematics Department, Khalifa University of Science and Technology, Abu Dhabi, UAE
  ...
  \item[Simon \textsc{Flavard}:] Laboratoire Magmas et Volcans, Universit\'e Clermont Auvergne, CNRS, IRD, OPGC, Clermont-Ferrand, France
  ...
  \item[Renaldo \textsc{Gastineau}:] EDYTEM, Universit\'e Savoie Mont-Blanc, CNRS, Le Bourget-du-Lac, France
  ...
  \item[St\'ephanie \textsc{Giroux-Julien}:] Centre d'\'Energ\'etique et de Thermique de Lyon (CETHIL), INSA de Lyon, France
  ...
  \item[Nicolas \textsc{Harrichhausen}:] Department of Geological Sciences, University of Alaska Anchorage, Anchorage, Alaska, USA
  \item[Wahyudi \textsc{Hasbi}:] Research Center for Satellite Technology, National Research and Innovation Agency, Bogor, Indonesia
  ...
  \item[Affiani \textsc{Machmudah}:] Research Center for Satellite Technology, National Research and Innovation Agency, Bogor, Indonesia
  ...
  \item[Herv\'e \textsc{Pabiou}:] Centre d'\'Energ\'etique et de Thermique de Lyon (CETHIL), INSA de Lyon, France
  \item[Mickael \textsc{Pailha}:] Laboratoire LOCIE UMR 5271, Polytech Annecy--Chamb\'ery, Le Bourget-du-Lac, France
  \item[Rapha\"el \textsc{Paris}:] Laboratoire Magmas et Volcans, Universit\'e Clermont Auvergne, CNRS, IRD, OPGC, Clermont-Ferrand, France
  ...
  \item[Andrea \textsc{Piccin}:] Hydrogeological Structure, Networks, and Water Domain, Territory and Green Systems Directorate, Region of Lombardy, Italy
  \item[Sandrine \textsc{Pincemin}:] EPF Engineering school, Montpellier, France
  \item[Ridanto Eko \textsc{Poetro}:] Faculty of Mechanical and Aerospace Engineering, Institut Teknologi Bandung, Bandung, Indonesia
  ...
  \item[Mustafa \textsc{\c{S}ahin}:] Department of Archaeology, Faculty of Arts and Sciences, Bursa Uluda\u{g} University, G\"or\"ukle, Bursa, Turkey
  ...
  \item[Fabio \textsc{Scardigli}:] Department of Mathematics, Politecnico di Milano, Milano, Italy
  ...
  \item[Julia \textsc{De Sigoyer}:] University Grenoble Alpes, University Savoie Mont Blanc, CNRS, IRD, IFSTTAR, Grenoble, France
  ...
  \item[Nur Deniz \textsc{\"Unsal}:] Department of Archaeology, Faculty of Arts and Sciences, Bursa Uluda\u{g} University, G\"or\"ukle, Bursa, Turkey
  ...
  \item[Pascal \textsc{Vuillemin}:] LLSETI (Languages, Literatures, Societies. Cross-Border and International Studies), University Savoie Mont Blanc, France
...
\begin{itemize}
  ...
  \item My $h-$index\footnote{This information is retrieved from Google Scholar server.}: \textbf{42}
...
\begin{etaremune}
  ...
  \item M.~Sukaiti, D.~Batic and \textbf{D.~Dutykh}. \textit{An exact Kerr-like rotating Morris--Thorne wormhole: throat, ergoregion and equatorial shadow}. Submitted, 2026 % No - (Arxiv, HAL, RG)

  \item D.~Batic, \textbf{D.~Dutykh} and M.~Sukaiti. \textit{Quasinormal modes of the Kazakov--Solodukhin quantum-corrected black hole: a spectral analysis}. Submitted, 2026 % No - (Arxiv, HAL, RG)

  \item D.~Batic, A.~Chrysostomou, A.~Cornell and \textbf{D.~Dutykh}. \textit{Quasinormal modes of Schwarzschild de Sitter black holes: spectral branches and the Nariai limit}. Submitted, 2026 % No - (Arxiv, HAL, RG)

  \item D.~Batic, A.~Chrysostomou, A.~Cornell and \textbf{D.~Dutykh}. \textit{Quasinormal modes analysis of a massive scalar field in a Schwarzschild background via the Spectral Method}. Submitted, 2026 % No - (Arxiv, HAL, RG)

  \item D.~Batic, \textbf{D.~Dutykh} and M.~Sukaiti. \textit{A no-go result for regular GR-connected isotropic Morris--Thorne wormholes in $f(R, T) = R + \sigma R T$ gravity}. Submitted, 2026 % No - (Arxiv, HAL, RG)
  
  \item D.~Batic, \textbf{D.~Dutykh}. \textit{Spectral Approximation Theory for Quasi-Normal Modes}. Submitted, 2026 % No - (Arxiv, HAL, RG)

  \item D.~Batic, \textbf{D.~Dutykh} and J.~Faraji. \textit{Spectral Method for Eigenvalue Problems in Quantum Mechanics}. Submitted, 2026 % No - (Arxiv, HAL, RG)

  \item S.~Mukherjee, L.~Bou Nassif, I.~Tsanakas, H.~Colin, S.~Giroux-Julien, H.~Pabiou, \textbf{D.~Dutykh} and L.~Vuillon. \textit{Beyond Black Boxes: Physics-Informed Graph Learning by Architecture for PV System Modelling}. Submitted, 2026 % No (HAL & Arxiv)
  ...
  \url{https://arxiv.org/abs/2409.10548/}
...
\begin{etaremune}
  ...
  \item S.~Mukherjee, L.~Vuillon, \textbf{D.~Dutykh} and I.~Tsanakas. \textit{Scalable weather data reduction for solar PV analysis using graph-based approach}. Accepted to Energy Systems, 2026 \\ % Yes - HAL, No (Arxiv, RG)
  \url{https://hal.science/hal-05235714/}

  \item M.K.~Andaristiyan, A.~Machmudah, R.E.~Poetro, W.~Hasbi and \textbf{D.~Dutykh}. \textit{Future Subsequent Ballistic Coefficient Estimation Using Deep Learning for Uncontrolled Reentry Object Prediction}. Accepted to Acta Astronaut., 2026 % No (HAL & Arxiv)

  \item D.~Batic, \textbf{D.~Dutykh} and F.~Scardigli. \textit{Quasinormal modes of Bonanno--Reuter black holes via the Spectral Method}. Accepted to Phys. Rev. D, 2026 % No - (Arxiv, HAL, RG)

  \item D.~Batic and \textbf{D.~Dutykh}. \textit{Quasinormal Modes of Gauss--Bonnet Black Holes via the Spectral Method: Scalar, Vector, and Tensor Perturbations}. Accepted to Phys. Rev. D, 2026 % No - (Arxiv, HAL, RG)

  \item A.~Rashidi, \textbf{D.~Dutykh} and M.~Mokhtari. \textit{Primarily tsunami modeling of the Mw 8.8 Kamchatka Peninsula earthquake on July 29, 2025}. Nat. Hazards, \textbf{122}, 450, 2026 % No - (Arxiv, HAL, RG)
  
  \item D.~Batic, C.~Boehmer and \textbf{D.~Dutykh}. \textit{Energy conditions in consistent perfect fluid cosmology}. Ann. Phys., \textbf{491}, 170517, 2026 \\ % Yes - Arxiv & RG, No - HAL
  \url{http://arxiv.org/abs/2605.14479/}
  
  \item D.~Batic, \textbf{D.~Dutykh} and M.~Sukaiti. \textit{Exact solutions for slowly rotating wormholes in the presence of an anisotropic fluid}. Class. Quantum Grav., \textbf{43}(9), 095007, 2026 \\ % No - (Arxiv, HAL, RG)
  \url{http://arxiv.org/abs/2605.02555/}

  \item D.~Batic, \textbf{D.~Dutykh} and M.~Sukaiti. \textit{Noncommutative geometry-inspired wormholes supported by quasi-de Sitter and Chaplygin-like equations of state}. Nucl. Phys. B, \textbf{1025}, 117414, 2026 \\ % Yes - (Arxiv & RG), No - HAL
  \url{http://arxiv.org/abs/2603.26257/}

  \item A.~Deeb, \textbf{D.~Dutykh} and M.~Al~Zohbi.  \textit{Error estimation for numerical approximations of ODEs via composition techniques. Part II: Backward difference formulas}. Comp. Appl. Math., \textbf{45}, 355, 2026 \\ % Yes - Arxiv & RG, No - HAL
  \url{http://arxiv.org/abs/2605.06735/}

  \item M.~Hunt and \textbf{D.~Dutykh}. \textit{Free Surface Waves in Electrohydrodynamics with Prescribed Vorticity Distribution}. Math. Methods Appl. Sci., \textbf{49}(7), 7068--7081, 2026 % No (HAL & Arxiv)

  \item D.~Batic, \textbf{D.~Dutykh} and M.~Sukaiti. \textit{Exact Spinning Morris--Thorne Wormhole: Causal Structure, Shadows, and Multipole Moments}. Eur. Phys. J. C, \textbf{86}, 179, 2026 \\ % Yes - (Arxiv, RG), No - HAL
  \url{http://arxiv.org/abs/2602.21906/}

  \item D.~Batic, \textbf{D.~Dutykh} and F.~Scardigli. \textit{Spectral Analysis of Quasinormal Modes of Planck Stars}. Eur. Phys. J. C, \textbf{86}, 165, 2026 \\ % Yes - Arxiv & RG, No - HAL
  \url{http://arxiv.org/abs/2602.19833/}

  \item R.~Escobedo, \textbf{D.~Dutykh}, and L.~Spector. \textit{Modeling How Hunting Strategies and Pack Size Shape Each Other}. J. Theor. Biol., \textbf{623}, 112390, 2026 \\ % Arxiv
  ...
  \item D.~Batic, \textbf{D.~Dutykh}, and Z.~Babou. \textit{Quasinormal modes of noncommutative geometry-inspired dirty black holes}. Proc. R. Soc. A, \textbf{481}(2318), 20250021, 2025 \\ % Yes - (Arxiv & RG), No - (HAL)
  ...
  \item D.~Batic, \textbf{D.~Dutykh} and B.L.~Giacchini. \textit{A unified spectral approach for quasinormal modes of Lee--Wick black holes}, Phys. Rev. D, \textbf{110}, 084032, 2024 \\ % Yes - (Arxiv & RG), No - (HAL)
...
\subsubsection{International Journals}
  ...
  \begin{itemize}
    ...
    \item \href{https://journals.aps.org/prl/}%
    {Physical Review Letters}
    
    \item \href{https://www.nature.com/commsphys/}%
    ...
    \item \href{https://www.degruyter.com/view/journals/jaa/jaa-overview.xml}%
    {Journal of Applied Analysis}
    
    \item \href{https://www.sciencedirect.com/journal/annals-of-physics/}%
    {Annals of Physics}
    
    \item \href{http://www.journals.elsevier.com/applied-ocean-research/}%
    {Applied Ocean Research}

    \item \href{https://pubs.aip.org/aapt/ajp/}%
    ...
    \item \href{https://www.sciencedirect.com/journal/journal-of-mathematical-analysis-and-applications/}%
    {Journal of Mathematical Analysis and Applications}
    
    \item \href{http://ascelibrary.org/wwo/}%
    {Journal of Waterway, Port, Coastal, and Ocean Engineering}

    \item \href{https://link.springer.com/journal/42286/}%
    ...
    \item \href{https://www.journals.elsevier.com/computer-physics-communications}%
    {Computer Physics Communications}
    
    \item \href{http://www.journals.elsevier.com/computers-and-mathematics-with-applications/}%
    {Computers and Mathematics with Applications}
    
    \item \href{https://link.springer.com/journal/40314/}%
    {Computational and Applied Mathematics}
    
    \item \href{http://www.springerlink.com/content/101751/}%
    {Numerical Algorithms}
    
    \item \href{http://www.journals.elsevier.com/communications-in-nonlinear-science-and-numerical-simulation}%
    {Communications in Nonlinear Science and Numerical Simulation}

    \item \href{https://www.sciencedirect.com/journal/coastal-engineering/}%
    {Coastal Engineering}

    \item \href{https://www.aimspress.com/journal/Math/}%
    {AIMS Mathematics}

    \item \href{https://link.springer.com/journal/13324/}%
    ...
    \item \href{https://www.sciencedirect.com/journal/journal-of-computational-and-applied-mathematics/}%
    ...
    \item \href{https://www.sciencedirect.com/journal/partial-differential-equations-in-applied-mathematics/}%
    {Partial Differential Equations in Applied Mathematics}

    \item \href{https://onlinelibrary.wiley.com/journal/16177061/}%
    {Proceedings in Applied Mathematics and Mechanics}
    
    \item \href{http://www.elsevier.com/wps/find/journaldescription.cws_home/601376/description#description}%
    {Ocean Modelling}
    
    \item \href{http://www.springer.com/engineering/civil+engineering/journal/40722/}%
    {Journal of Ocean Engineering and Marine Energy}
    
    \item \href{https://www.tandfonline.com/toc/tbps20/current/}%
    {Journal of Building Performance Simulation}

    \item \href{https://www.sciencedirect.com/journal/physica-d-nonlinear-phenomena/}%
    {Physica D: Nonlinear Phenomena}
    
    \item \href{http://www.journals.elsevier.com/physics-letters-a/}%
    {Physics Letters A}
    
    \item \href{https://www.sciencedirect.com/journal/physics-of-the-dark-universe/}%
    {Physics of the Dark Universe}
    
    \item \href{http://www.siam.org/journals/siap.php}%
    {SIAM Journal on Applied Mathematics}
    
    \item \href{https://www.sciencedirect.com/journal/softwarex/}%
    {SoftwareX}

    \item \href{https://www.sciencedirect.com/journal/solar-energy/}%
    {Solar Energy}
  
    \item \href{http://www.elsevier.com/locate/wavemoti}%
    {Wave Motion}

    \item \href{https://www.sciencedirect.com/journal/marine-pollution-bulletin/}%
    {Marine Pollution Bulletin}
    
    \item \href{https://www.mdpi.com/journal/mca}%
    {Mathematical and Computational Applications}
    
    \item \href{https://onlinelibrary.wiley.com/journal/10991476/}%
    {Mathematical Methods in the Applied Sciences}

    \item \href{https://www.mdpi.com/journal/atmosphere/}%
    {Atmosphere}
    
    \item \href{https://www.mdpi.com/journal/geosciences/}%
    {Geosciences}

    \item \href{https://www.mdpi.com/journal/geohazards/}%
    {Geohazards}

    \item \href{https://www.mdpi.com/journal/oceans/}%
    {Oceans}
    
    \item \href{https://www.sciencedirect.com/journal/optik/}%
    {Optik}
    
    \item \href{http://www.nat-hazards-earth-syst-sci.net/}%
    {Natural Hazards and Earth System Sciences}

    \item \href{https://www.aimspress.com/journal/nhm/}%
    {Networks and Heterogeneous Media}

    \item \href{https://www.sciencedirect.com/journal/building-and-environment}%
    {Building and Environment}
    
    \item \href{http://www.terrapub.co.jp/journals/EPS/}%
    {Earth, Planets and Space (EPS)}
    
    \item \href{http://www.icevirtuallibrary.com/content/serial/eacm/}%
    {ICE --- Engineering and Computational Mechanics}
    
    \item \href{http://www.ashdin.com/journals/jace/jace.aspx}%
    {Journal of Advanced Chemical Engineering}
    
    \item \href{http://www.springer.com/engineering/civil+engineering/journal/12205}%
    {KSCE Journal of Civil Engineering}
    
    \item \href{http://hydrophysics.info/?lang=en}%
    {Fundamental and Applied Hydrophysics}
    
    \item \href{http://www.mdpi.com/journal/symmetry}%
    {Symmetry}
    
    \item \href{http://pubcouncil.kuniv.edu.kw/kjs/}%
    {Kuwait Journal of Science \& Engineering}
    
    \item \href{http://www.degruyter.com/view/j/zna}%
    {Zeitschrift f\"ur Naturforschung A}
    
    \item \href{http://www.springer.com/mathematics/journal/12215}%
    {Rendiconti del Circolo Matematico di Palermo }
    
    \item \href{https://www.degruyter.com/view/j/eng}%
    {Open Engineering}

    \item \href{https://www.sciencedirect.com/journal/journal-of-ocean-engineering-and-science/}%
    {Journal of Ocean Engineering and Science}

    \item \href{https://www.sciencedirect.com/journal/journal-of-engineering-research/}%
    {Journal of Engineering Research}
    
    \item \href{http://www.polarforschung.de/}%
    {Polarforschung}
    
    \item \href{https://link.springer.com/journal/11071}%
    {Nonlinear Dynamics}

    \item \href{https://link.springer.com/journal/12346}%
    {Qualitative Theory of Dynamical Systems}

    \item \href{https://www.mdpi.com/journal/jmse/}%
    {Journal of Marine Science and Engineering}

    \item \href{https://link.springer.com/journal/10773/}%
    {International Journal of Theoretical Physics}

    \item \href{https://link.springer.com/journal/10236/}%
    {Ocean Dynamics}
    
    \item \href{https://www.mdpi.com/journal/mca/}%
    {Mathematical and Computational Applications}

    \item \href{https://www.mdpi.com/journal/biomimetics/}%
    {Biomimetics}

    \item \href{https://www.frontiersin.org/journals/physics/}%
    {Frontiers in Physics}

    \item \href{https://gjom.org/}%
    {Gulf Journal of Mathematics}

    \item \href{https://www.frontiersin.org/journals/plant-science/}%
    {Frontiers in Plant Science}

    \item \href{https://www.mdpi.com/journal/algorithms/}%
    {Algorithms}

    \item \href{http://control.ibspan.waw.pl:3000/mainpage/}%
    {Control and Cybernetics}

    \item \href{https://www.mdpi.com/journal/drones/}%
    {Drones}

    \item \href{https://www.mdpi.com/journal/fractalfract/}%
    {Fractal and Fractional}

    \item \href{https://www.mdpi.com/journal/mathematics/}%
    {Mathematics}

    \item \href{https://www.mdpi.com/journal/electronics/}%
    {Electronics}

    \item \href{https://www.mdpi.com/journal/energies/}%
    {Energies}

    \item \href{https://www.mdpi.com/journal/plants/}%
    {Plants}

    \item \href{https://www.mdpi.com/journal/sustainability/}%
    {Sustainability}

    \item \href{https://www.mdpi.com/journal/technologies/}%
    {Technologies}

    \item \href{https://www.mdpi.com/journal/fire/}%
    {Fire}

    \item \href{https://ojs.ukscip.com/index.php/ptnd/}%
    {Prevention and Treatment of Natural Disasters}

    \item \href{https://www.aimspress.com/journal/mina/}%
    {Metascience in Aerospace}

    \item \href{https://www.mdpi.com/journal/agriengineering/}%
    {AgriEngineering}
    
    \item \href{https://www.mdpi.com/journal/agronomy/}%
    {Agronomy}

    \item \href{https://www.mdpi.com/journal/applsci/}%
    {Applied Sciences}
    
    \item \href{https://www.sciencedirect.com/journal/computers-in-industry/}%
    {Computers in Industry}

    \item \href{https://www.sciencedirect.com/journal/results-in-physics/}%
    {Results in Physics}

    \item \href{https://www.sciencedirect.com/journal/environmental-research/}%
    {Environmental Research}
    
    \item \href{https://journals.bilpubgroup.com/index.php/jees/}%
    {Journal of Environmental \& Earth Sciences}

    \item \href{https://www.mdpi.com/journal/wevj/}%
...
\subsubsection{International Conferences}
  ...
  \begin{itemize}
    ...
    \item \href{https://event.asme.org/OMAE/About/OMAE-2026/}%
    {OMAE 2026}
  
    \item \href{http://www.wias-berlin.de/workshops/fvca7/}%
    {FVCA VII}
    
    \item \href{http://fvca6.fs.cvut.cz/}%
    {FVCA VI}
    
    \item \href{http://www.isope2010.org/}%
    {ISOPE 2010}
    
    \item \href{http://ictam2008.adelaide.edu.au/}%
    {ICTAM 2008}
    
    \item \href{http://www.isope.org/conferences/conferences.htm}%
    {ISOPE 2007}
    
    \item \href{http://www.latp.univ-mrs.fr/fvca5/}%
    {FVCA V}
...
\subsubsection{Book proposals}
  ...
  \begin{itemize}
    \item \href{http://www.springer.com/}%
    {Springer Science}
  \end{itemize}
...
\subsubsection{Calls for proposals}
  ...
  \begin{itemize}
    ...
    \item \href{https://research.kuleuven.be/en/collaborate/science_business/iof/}%
    {KU Leuven Industrial Research Fund Council}
  
    \item \href{http://research.ie/}%
    {Irish Research Council}
    
    \item \href{https://www.isf.org.il/}%
    {Israel Science Foundation}
    
    \item \href{https://www.kaust.edu.sa/en}%
    {KAUST Research Proposals}
  
    \item \href{http://www.ulg.ac.be/cms/rv_2913816/en/about}%
    {Marie Curie COFUND}
    ...
    \item \href{https://www.snf.ch/en/}%
    {Swiss National Science Foundation}
    
    \item \href{http://seagrant.oregonstate.edu/}%
    {Oregon Sea Grant}
...
\begin{description}
  ...
  \item[Fall 2025:] Research Seminar II Graduate Course (SCIE703, $0$ credits) at the College of Computing and Mathematical Sciences, Khalifa University of Science and Technology, Abu Dhabi, UAE

  \item[Fall 2025:] Instructor for Calculus III (MATH231, $3$ credits) after J.~Stewart's book at the College of Computing and Mathematical Sciences, Khalifa University of Science and Technology, Abu Dhabi, UAE
...
\begin{itemize}
  ...
  \item (2022 -- 2025) \textbf{Muhammad Naveed~\textsc{Zafar}}: Co-supervision with Prof.~Pierre~\textsc{Sabatier} (EDYTEM/University Savoie Mont Blanc). PhD thesis title: ``\textit{Numerical modelling of lacustrine paleotsunamis constrained by their geological records}''. Defended on the 25\up{th} of November 2025.
