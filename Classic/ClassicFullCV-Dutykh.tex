...
\begin{etaremune}
  ...
  \item S.~Mukherjee, L.~Vuillon, \textbf{D.~Dutykh} and I.~Tsanakas. \textit{Scalable weather data reduction for solar PV analysis using graph-based approach}. Accepted to Energy Systems, 2025 % No (HAL, Arxiv, RG)
