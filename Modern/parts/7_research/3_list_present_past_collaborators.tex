...
\begin{description}
  ...
  \item[Ahmed \textsc{Abdalazeez}:] Department of Marine Systems, School of Science, Tallinn University of Technology
  \item[Nizar \textsc{Abcha}:] Laboratoire Morphodynamique Continentale et C\^oti\`ere (UMR 6143 M2C), Universit\'e de Caen Normandie, France
  \item[Madina \textsc{Abdykarim}:] Laboratoire LOCIE UMR 5271, Polytech Annecy--Chamb\'ery, France
  \item[Iskander \textsc{Abroug}:] Laboratoire Morphodynamique Continentale et C\^oti\`ere (UMR 6143 M2C), Universit\'e de Caen Normandie, France
  ...
  \item[Aydar \textsc{Assylbekuly}:] (formerly at) Khoja Akhmet Yassawi International Kazakh--Turkish University, Kazakhstan
  ...
  \item[Mathilde \textsc{Banjan}:] Laboratoire Environnements, Dynamiques et Territoires de Montagne (EDYTEM), University Savoie Mont Blanc, France
  ...
  \item[Rafik \textsc{Belarbi}:] Laboratoire des Sciences de l'Ing\'enieur pour l'Environnement (LaSIE UMR 7356), Universit\'e de La Rochelle, France
  \item[Julien \textsc{Berger}:] Laboratoire des Sciences de l'Ing\'enieur pour l'Environnement (LaSIE UMR 7356), Universit\'e de La Rochelle, France
  \item[Denis \textsc{Blackmore}:] Department of Mathematical Sciences, New Jersey Institute of Technology, USA
  \item[St\'ephanie \textsc{Bolik}:] Labotatoire Physiologie Cellulaire et V\'eg\'etale (LPCV), CEA, CNRS, INRA, Grenoble, France
  \item[Maximilien \textsc{Bowen}:] Laboratoire Interuniversitaire de Biologie de la Motricit\'e (LIBM), Universit\'e Savoie Mont Blanc, France
  \item[Didier \textsc{Bresch}:] Laboratoire de Math\'ematiques (LAMA), Universit\'e Savoie Mont Blanc, France
  ...
  \item[John D. \textsc{Carter}:] Mathematics Department, Seattle University, USA
  ...
  \item[Fr\'ed\'eric \textsc{Dias}:] School of Mathematical Sciences, University College Dublin, Ireland
  \item[Ira \textsc{Didenkulova}:] Department of Marine Systems, School of Science, Tallinn University of Technology
  \item[Evgueni \textsc{Dinvay}:] (formerly at) Department of Mathematics, University of Bergen, Norway
  ...
  \item[Philippe \textsc{Djorw\'e}:] Department of Physics, University of Ngaoundere, Cameroon
  \item[John M. \textsc{Dudley}:] Institut FEMTO-ST, University of Franche-Comt\'e, France
  ...
  \item[Gennady \textsc{El}:] Department of Mathematical Sciences, Loughborough University, UK
  ...
  \item[Francesco \textsc{Fedele}:] School of Civil and Environmental Engineering, Georgia Institute of Technology, USA
  ...
  \item[Andr\'e \textsc{Galligo}:] Laboratoire J.A.~Dieudonn\'e, Universit\'e de Nice Sophia Antipolis, France
  \item[Ivan \textsc{Gandzha}:] Department of Theoretical Physics, Institute of Physics, Kiev, Ukraine
  \item[Suelen \textsc{Gasparin}:] Laboratoire des Sciences de l'Ing\'enieur pour l'Environnement (LaSIE UMR 7356), Universit\'e de La Rochelle, France
  \item[Hugo \textsc{Geoffroy}:] (formerly at) Laboratoire LOCIE UMR 5271, Polytech Annecy--Chamb\'ery, France
  ...
  \item[Marguerite \textsc{Gisclon}:] Laboratoire de Math\'ematiques (LAMA), Universit\'e Savoie Mont Blanc, France
  \item[Jean-Michel \textsc{Ghidaglia}:] Centre de Math\'ematiques et de Leurs Applications, Ecole Normale Sup\'erieure de Cachan, France
  ...
  \item[Vincent \textsc{Guinot}:] HydroSciences Montpellier, University of Montpellier, France
  ...
  \item[Matthew \textsc{Hunt}:] Warwick Mathematics Institute, University of Warwick, UK
  ...
  \item[Henrik \textsc{Kalisch}:] Department of Mathematics, University of Bergen, Norway
  \item[Christophe \textsc{Kassiotis}:] (formerly at) Laboratoire d'hydraulique Saint-Venant, ENPC, EDF R\&D Chatou, France
  \item[Theodoros \textsc{Katsaounis}:] Department of Applied Mathematics, University of Crete, Greece
  ...
  \item[Kamila \textsc{Kotrasova}:] Faculty of Civil Engineering, Technical University of Kosice, Slovak Republic
  ...
  \item[C\'eine \textsc{Labart}:] Laboratoire de Math\'ematiques (LAMA), Universit\'e Savoie Mont Blanc, France
  ...
  \item[Qian \textsc{Li}:] (formerly at) School of Mathematics, Statistics and Operations Research, Victoria University of Wellington, New Zealand
  ...
  \item[Reine \textsc{Matar}:] Laboratoire Morphodynamique Continentale et C\^oti\`ere (UMR 6143 M2C), Universit\'e de Caen Normandie, France
  \item[Nathan \textsc{Mendes}:] Pontifical Catholic University of Paran\'a, Curitiba, Brazil
  \item[Christophe \textsc{M\'en\'ezo}:] Laboratoire LOCIE UMR 5271, Polytech Annecy--Chamb\'ery, France
  \item[Paul \textsc{Milewski}:] Department of Mathematical Sciences, University of Bath, Bath, UK
  \item[Dimitrios \textsc{Mitsotakis}:] School of Mathematics, Statistics and Operations Research, Victoria University of Wellington, New Zealand
  ...
  \item[Daulet \textsc{Moldabayev}:] (formerly at) Department of Mathematics, University of Bergen, Norway
  \item[Baptiste \textsc{Morel}:] Laboratoire Interuniversitaire de Biologie de la Motricit\'e (LIBM), Universit\'e Savoie Mont Blanc, France
  \item[Srijani \textsc{Mukherjee}:] Laboratoire de Math\'ematiques (LAMA), Universit\'e Savoie Mont Blanc, France
  ...
  \item[Chioukh \textsc{Nadjib}:] Department of Hydraulics, University Djillali Liabes of Sidi Bel-Abbes, Algeria
  \item[Hayk \textsc{Nersisyan}:] (formerly at) BCAM -- Basque Center for Applied Mathematics, Bilbao, Spain
  \item[Dezhi \textsc{Ning}:] State Key Laboratory of Coastal and Offshore Engineering, Dalian University of Technology, China
  ...
  \item[Setyamartana \textsc{Parman}:] Fakulti Teknologi Kejuruteraan Mekanikal dan Pembuatan, Universiti Teknikal Malaysia Melaka, Malaysia
  \item[Siddhartha \textsc{Pati}:] SIAN Institute, Association for Biodiversity Conservation and Research (ABC), Balasore, India
  \item[Elijah \textsc{Peach}:] School of Mathematics, Statistics and Operations Research, Victoria University of Wellington, New Zealand
  ...
  \item[Rapha\"el \textsc{Poncet}:] (formerly at) CEA DAM, Ile-de-France, France
  ...
  \item[Sobia \textsc{Qazi}:] Department of Foundation Engineering and Physical
Science, University of Nottingham, UK
  ...
  \item[William \textsc{Rapuc}:] Laboratoire Environnements, Dynamiques et Territoires de Montagne (EDYTEM), University Savoie Mont Blanc, France
  \item[Amin \textsc{Rashidi}:] Institute of Geophysics, University of Tehran, Tehran, Iran
  \item[Emiliano \textsc{Renzi}:] Mathematical Sciences, Loughborough University, UK
  ...
  \item[Pierre \textsc{Sabatier}:] Laboratoire Environnements, Dynamiques et Territoires de Montagne (EDYTEM), University Savoie Mont Blanc, France
  ...
  \item[Pierre \textsc{Samozino}:] Laboratoire Interuniversitaire de Biologie de la Motricit\'e (LIBM), Universit\'e Savoie Mont Blanc, France
  ...
  \item[Dmitry \textsc{Senichev}:] (formerly at) Nizhny Novgorod State Technical Universit, Nizhny Novgorod, Russia
  \item[Madhavan \textsc{Shanmugavel}:] Department of Mechatronics, SRM Institute of Science and Technology, Chennai, India
  \item[s. Hadi \textsc{Shamsnia}:] Department of Geophysics, Tehran University, Iran
  ...
  \item[Dmitri \textsc{Sokolovski}:] Department of Physical Chemistry, Faculty of Sciences and Technology at UPV/EHU in Leioa, Spain
  ...
  \item[Themistoklis \textsc{Stefanakis}:] (formerly at) CMLA, ENS de Cachan and School of Mathematical Sciences, University College Dublin, Ireland
  ...
  \item[Elena \textsc{Tobisch} (\textsc{Kartashova}):] Institut f\"ur Analysis, Johannes Kepler Universit\"at Linz, Austria
  ...
  \item[Myl\`ene \textsc{Vonderscher}:] Laboratoire Interuniversitaire de Biologie de la Motricit\'e (LIBM), Universit\'e Savoie Mont Blanc, France
  \item[Jean-Louis \textsc{Verger-Gaugry}:] Laboratoire de Math\'ematiques (LAMA), Universit\'e Savoie Mont Blanc, France
  \item[Claudio \textsc{Viotti}:] (formerly at) School of Mathematical Sciences, University College Dublin, Ireland
  \item[Laurent \textsc{Vuillon}:] Laboratoire de Math\'ematiques (LAMA), Universit\'e Savoie Mont Blanc, France
  ...
  \item[Muhammad Naveed \textsc{Zafar}:] Laboratoire Environnements, Dynamiques et Territoires de Montagne (EDYTEM), University Savoie Mont Blanc, France 
  \item[Arghir \textsc{Zarnescu}:] BCAM -- Basque Center for Applied Mathematics, Bilbao, Spain
  \item[Dauren \textsc{Zhakebayev}:] Al-Farabi Kazakh National University, Kazakhstan
  \item[Enrique \textsc{Zuazua}:] Departamento de Matem\'aticas, Universidad Aut\'onoma de Madrid, Madrid, Spain
\end{description}